...
<footer className="bg-gray-200 dark:bg-gray-900 relative bottom-0 w-full">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="/" className="">
              <h1 className="text-4xl font-bold text-primaryColor">GreenEco</h1>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 className="mb-6 text-sm font-bold text-gray-900 uppercase dark:text-white">About us</h2>
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/lexuantan159/website-greeneco.git" className="hover:underline ">Github</a>
                      </li>
                      <li>
